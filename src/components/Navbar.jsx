              ...
              return (
                <a
                  ...
                  className={clsx(
                    ...
                    isActive ? 'border-2 rounded-full border-[#EF641C] text-white font-semibold' : 'text-white/90 hover:text-white'
                  )}
                >
                      ...
                      >
                        <Link
                          ...
                          className={clsx(
                            ...
                            isActive ? 'border-2 rounded-full border-[#EF641C] text-white font-semibold' : 'text-white/90 hover:text-white/95'
                          )}
                        >
                          <span>{l.label}</span>
                        </Link>
